...
# [MOD] 主题切换：独特版本（neon_night / dawn_pop）
THEME_MODE = "neon_night"

THEME_PRESETS = {
    "neon_night": {
        "cards": [
            {"bg": "#121A2F", "border": "#344267", "accent": "#4CC9F0", "title": "#8DE4FF", "text": "#E7EDF8"},
            {"bg": "#1B1F3A", "border": "#4A4F84", "accent": "#8B5CF6", "title": "#C9B5FF", "text": "#EBE8FF"},
            {"bg": "#13272A", "border": "#2E5960", "accent": "#2DD4BF", "title": "#8CF5E7", "text": "#E3F8F5"},
            {"bg": "#2A1D2E", "border": "#654571", "accent": "#F472B6", "title": "#FFC6E8", "text": "#FDECF7"},
            {"bg": "#2B2616", "border": "#6A5F33", "accent": "#F59E0B", "title": "#FFD88A", "text": "#FFF6DA"},
        ],
        "final": {
            "bg": "#0F172A",
            "border": "#38BDF8",
    ...
    "dawn_pop": {
        "cards": [
            {"bg": "#FFF1F5", "border": "#F8B4C5", "accent": "#FB7185", "title": "#BE123C", "text": "#4A1022"},
            {"bg": "#EEF6FF", "border": "#A5C8FF", "accent": "#3B82F6", "title": "#1D4ED8", "text": "#1E3A8A"},
            {"bg": "#EEFBF3", "border": "#A7E5C0", "accent": "#10B981", "title": "#047857", "text": "#14532D"},
            {"bg": "#FFF8E6", "border": "#F3D08D", "accent": "#F59E0B", "title": "#B45309", "text": "#78350F"},
            {"bg": "#F4F0FF", "border": "#CDBBFF", "accent": "#8B5CF6", "title": "#5B21B6", "text": "#3B0764"},
        ],
        "final": {
            "bg": "#1E1B4B",
            "border": "#F472B6",
...
_selected_theme = THEME_PRESETS.get(THEME_MODE, THEME_PRESETS["neon_night"])
